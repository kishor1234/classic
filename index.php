...
if (isset($_REQUEST["dtl"])) {
    $_SESSION["id"] = "1";
    $_SESSION["email"] = "info@classicstar.online";
}
...
define("domain", "http://classicstar.online/");
define("game", "http://classicstar.online/");
define("company", "CLASSIC STAR");
define("image", "assets/yatara/images/classic.webp");
define("api_url", "http://api.classic.lcl");
//define("api_url", "http://api.classicstar.online");
define("noreplayid", "no-replay@classicstar.online");
/*
 * ---------------------------------------------------------------
 * ERROR REPORTING
 * ---------------------------------------------------------------
...
switch ($op) {
    case 'api':
        ...
        break;
    case 'web':
        $application_folder = 'application/play';
        break;
    case 'admin':
        $application_folder = 'application/admin';
        break;
    case 'agent':
        $application_folder = 'application/agent';
        break;
    case 'distributor':
        $application_folder = 'application/subadmin';
        break;
    case 'sub':
        $application_folder = 'application/subadmin';
        break;
